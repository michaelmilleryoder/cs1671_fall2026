...
|TA| Yuelyu Ji |
|TA contact| [yuj49@pitt.edu](mailto:yuj49@pitt.edu) |
|TA office hours| Th 4-5pm, IS 707 and on Zoom (see Canvas announcement) |
|Textbook (free online)|[[J+M] Jurafsky and Martin, *Speech and Language Processing*, 3e draft, 2026-08-19](https://web.stanford.edu/~jurafsky/slp3)|
|CRCD class environment path| /ix1/cs1671-2026f/class-env/.pixi/envs/default
|Class notebooks |[CRCD JupyterHub nbgitpuller link](https://jupyter.crc.pitt.edu/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2Fmichaelmilleryoder%2Fcs1671_fall2026_jupyterhub&urlpath=lab%2Ftree%2Fcs1671_fall2026_jupyterhub%2F&branch=main) (Pitt login required, public link to source [here](https://github.com/michaelmilleryoder/cs1671_fall2026_jupyterhub)).|


# Schedule
*Subject to change. Last revised 2026-09-10. All due dates are at 11:59pm ET except when indicated.*
...
<table class="schedule">
    ...
    <tbody>
        ...
        <tr>
            <td>1</td>
            <td>08-25 Tu</td>
            <td><a href="slides/session1_cs1671_fall2026.pdf">Course, NLP intro</a></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>2</td>
            <td>08-27 Th</td>
            <td><a href="slides/session2_cs1671_fall2026.pdf">Python for data science</a></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>3</td>
            <td>09-01 Tu</td>
            <td><a href="slides/session3_cs1671_fall2026.pdf">Words, tokens, and preprocessing</a></td>
            <td>J+M 2-2.6, 2.8, 2.10</td>
            <td><a href="hw1">HW1</a> out 09-02</td>
        </tr>
        <tr>
            <td>4</td>
            <td>09-03 Th</td>
            <td><a href="slides/session4_cs1671_fall2026.pdf">Probability and linear algebra review</a></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>5</td>
            <td>09-08 Tu</td>
            <td><a href="slides/session5_cs1671_fall2026.pdf">Machine learning intro, NLP tasks and applications</a></td>
            <td></td>
            <td><a href="https://forms.cloud.microsoft/r/fe5w2jWkd1">Project idea form</a> out</td>
        </tr>
	<tr>
        ...
        <tr>
            <td>6</td>
            <td>09-10 Th</td>
            <td><a href="slides/session6_cs1671_fall2026.pdf">Bag-of-words and n-grams</a></td>
            <td>J+M 5.4, 11.1.1</td>
            <td></td>
        </tr>
        <tr>
            <td>7</td>
            <td>09-15 Tu</td>
            <td><a href="slides/session7_cs1671_fall2026.pdf">N-gram language models</a></td>
            <td>J+M 3-3.6.2, 3.8</td>
            <td>In-class quiz;<br/><strong><a href="https://forms.cloud.microsoft/r/fe5w2jWkd1">Project idea form</a> due</strong></td>
        </tr>
        <tr>
            <td>8</td>
            <td>09-17 Th</td>
            <td><a href="slides/session8_cs1671_fall2026.pdf">Logistic regression part 1</a></td>
            <td>J+M 4-4.3</td>
            <td><strong><a href="hw1">HW1</a> due</strong></td>
        </tr>
        <tr>
            <td>9</td>
            <td>09-22 Tu</td>
            <td><a href="slides/session9_cs1671_fall2026.pdf">Project match day, CRCD tutorial</a></td>
            <td></td>
            <td>In-class quiz</td>
        </tr>
        <tr>
            <td>10</td>
            <td>09-24 Th</td>
            <td><a href="slides/session10_cs1671_fall2026.pdf">Logistic regression part 2</a></td>
        ...
        <tr>
            ...
            <td>In-class quiz;<br/>HW2 out 09-30</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>J+M 6.5-6.6</td>
            <td><strong><a href="project.html#project-deliverable-1">Project deliverable 1</a> due</strong></td>
        </tr>
        <tr>
            <td>15</td>
            <td>10-13 Tu</td>
        ...
        <tr>
            ...
            <td>J+M 9-9.3, 9.5</td>
            <td>In-class quiz;<br/>HW3 out 10-28</td>
        </tr>
        <tr>
            <td>20</td>
            <td>10-29 Th</td>
            ...
            <td><strong><a href="project.html#deliverable-2">Project deliverable 2</a> due</strong></td>
        </tr>
        <tr>
            <td>21</td>
            <td>11-03 Tu</td>
        ...
        <tr>
            <td>26</td>
            <td>11-19 Th</td>
            <td><em>Guest lecture</em></td>
            <td></td>
            <td></td>
        </tr>
        <tr style="background-color:#cccccc">
            <td colspan=5 style="text-align:center; font-style:italic">Thanksgiving break 11-23 to 11-27</td>
        </tr>
        <tr>
            <td>27</td>
            <td>12-01 Tu</td>
        ...
        <tr>
            ...
            <td></td>
            <td><strong>Project report due 12-08</strong></td>
        </tr>
    </tbody>
</table>
...
---|---:|---:
**Homework assignments total** | **340** | **34**
&ensp;[Homework 1](hw1) | 70 | 7
&ensp;Homework 2 | 135 | 13.5
&ensp;Homework 3 | 135 | 13.5
**Project total** | **300** | **30**
&ensp;Project idea form | 5 | 0.5
&ensp;Project deliverable 1 | 55 | 5.5
&ensp;Project deliverable 2 | 75 | 7.5
&ensp;Final report | 160 | 16
&ensp;Final presentation | 5 | 0.5
**Quizzes total** | **60** | **6**
&ensp;Each quiz of 7 total, lowest score dropped | 10 | 1
**Exam** | **200** | **20**
...
* Choose appropriate techniques for adapting LLMs to a use case, including prompting and finetuning
* Be able to interpret the output of LLMs and describe their limitations

# Prerequisites
* CS 1501 Algorithms and Data Structures 2 (grade C or better)
* MATH 280 Introduction to Matrices and Linear Algebra, or MATH 1180 Linear Algebra 1
...
## Late work policy
Students are granted 3 late days (total, across the entire semester) for homework assignments without penalty. After those late days, you will be penalized 10% for each day that your submission is late up to a maximum of 40%. No work will be accepted later than 2 weeks after the due date.
...
Our goal is to be clear about what resources are allowed for different assessments, and you can always ask teaching staff about what is allowed.
